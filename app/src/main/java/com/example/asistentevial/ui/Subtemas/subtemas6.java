...
import com.example.asistentevial.ui.Preguntas.PreguntasActivity6;
import com.google.android.material.bottomnavigation.BottomNavigationView;


public class subtemas6 extends AppCompatActivity {
    Button button1;
    Button button2;
    Button button3;
    Button btnVolver;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.subtemas6);
        ...
        btnVolver.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                NavController navController = Navigation.findNavController(subtemas6.this, R.id.nav_host_fragment_activity_main);
        ...
        button1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(subtemas6.this, PreguntasActivity6.class);
