...
import com.example.asistentevial.ui.Preguntas.PreguntasActivity5;
import com.google.android.material.bottomnavigation.BottomNavigationView;


public class subtemas5 extends AppCompatActivity {
    Button button1;
    Button button2;
    Button button3;
    Button btnVolver;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.subtemas5);
        ...
        btnVolver.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                NavController navController = Navigation.findNavController(subtemas5.this, R.id.nav_host_fragment_activity_main);
        ...
        button1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(subtemas5.this, PreguntasActivity5.class);
